...
{   
    ...
    public function get_my($page, $viewer)
    {
        ...
        return [
            'items' => UserResource::collection($this->filterUserList($pages, $viewer, 'id', ['active'])),
    ...
    {
        $email = $data['user_name'].'@'.config('shaun_core.core.email_domain_default'); 
