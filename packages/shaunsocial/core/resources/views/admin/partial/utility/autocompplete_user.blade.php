            ...
            transformResult: function(response) {
                ...
                return {
                    suggestions: $.map(response.data, function(dataItem) {
                        return { name: dataItem.name, value: dataItem.id.toString(), avatar: dataItem.avatar };
                    })
                }
            },
            formatResult: function (suggestion) {
                return '<div class="autocomplete-suggestion-user-item"><img class="autocomplete-suggestion-user-item-avatar" src="' + suggestion.avatar+'" /><div class="autocomplete-suggestion-user-item-name"> '  + suggestion.name + '</div></div>';
            },
            'ignoreParams': true,
            'deferRequestBy' : 1000,
            'noCache' : true
