...
Route::group(['middleware' => ['auth:sanctum', 'api'], 'prefix' => 'api'], function () {    
    ...
    Route::get('subscription/get/{status}/{page?}', [SubscriptionController::class, 'get'])->where(['page' => '[0-9]+'])->whereIn('status', ['all', 'active', 'cancel', 'stop'])->name('subscription_get');
    ...
    Route::get('country/get', [CountryController::class, 'get'])->name('country_get');
    Route::get('country/get_state/{country_id}', [CountryController::class, 'get_state'])->where(['country_id' => '[0-9]+'])->name('country_get_state');
    Route::get('country/get_city/{state_id}', [CountryController::class, 'get_city'])->where(['state_id' => '[0-9]+'])->name('country_get_state');
});
