...
('site.version', 'Version', '', '1.2.0', '', 'text', 0, 0, 0, 1),
...
('site.favicon_image', 'Favicon image', 'We recommend using an image with a resolution of 16x16 for favicon image.', '', '{"default":"favicon.ico","style_width":"20","extensions":"jpeg,jpg,png,ico"}', 'image', 24, 1, 3, 0),
...
('spam.signup_enable_recapcha', 'Enable reCAPTCHA in signup form', '', '0', '', 'checkbox', 6, 2, 7, 0),
('spam.login_enable_recapcha', 'Enable reCAPTCHA in login form', '', '0', '', 'checkbox', 7, 2, 7, 0),
('spam.contact_enable_recapcha', 'Enable reCAPTCHA in contact form', '', '0', '', 'checkbox', 8, 2, 7, 0),
('spam.share_email_enable_recapcha', 'Enable reCAPTCHA in share email', '', '0', '', 'checkbox', 9, 2, 7, 0),
('spam.invite_email_enable_recapcha', 'Enable reCAPTCHA in invite email', '', '0', '', 'checkbox', 10, 2, 7, 0),
...
('layout_pages', 'title', 2, 'en', 'Landing Page'),
...
('layout_contents', 'title', 18, 'en', 'User Suggest'),
('layout_contents', 'content', 18, 'en', ''),
('layout_contents', 'title', 19, 'en', 'Hashtag Suggest'),
('layout_contents', 'content', 19, 'en', ''),
('layout_contents', 'title', 20, 'en', 'User Trending'),
('layout_contents', 'content', 20, 'en', ''),
('layout_contents', 'title', 21, 'en', 'Hashtag Trending'),
...
('layout_contents', 'title', 22, 'en', 'User Suggest'),
...
('layout_contents', 'title', 25, 'en', 'User Trending'),
('layout_contents', 'content', 25, 'en', ''),
('layout_contents', 'title', 26, 'en', 'Hashtag Trending'),
...
('layout_contents', 'title', 29, 'en', 'User Trending'),
...
('layout_contents', 'title', 32, 'en', 'User Trending'),
...
('permissions', 'message_error', 24 ,'en', 'You only can share a post that has max [x] characters.'),
('permissions', 'message_error', 25 ,'en', 'You only can share a video that has max [x] seconds.'),
...
('UserSuggest', 'User Suggest Block', 1, 'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserSuggestWidget', 0, NOW(), NOW()),
('HashtagSuggest', 'Hashtag Suggest Block', 1, 'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\HashtagSuggestWidget', 0, NOW(), NOW()),
('UserTrending', 'User Trending Block', 1, 'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserTrendingWidget', 0, NOW(), NOW()),
('HashtagTrending', 'Hashtag Trending Block', 1, 'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\HashtagTrendingWidget', 0, NOW(), NOW()),
...
(2, 'router', 'Landing Page', NULL, NULL, 'landing_page.index', 0, NOW(), NOW()),
...
(18, 3, 'right', 'component', 'User Suggest', NULL, 1, 'UserSuggest', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserSuggestWidget' ,NOW(), NOW(), 'shaun_core'),
(19, 3, 'right', 'component', 'Hashtag Suggest', NULL, 1, 'HashtagSuggest', 'desktop', '["all"]' ,'{"item_number":"10"}', 2,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\HashtagSuggestWidget' ,NOW(), NOW(), 'shaun_core'),
(20, 4, 'right', 'component', 'User Trending', NULL, 1, 'UserTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
(21, 4, 'right', 'component', 'Hashtag Trending', NULL, 1, 'HashtagTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 2,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\HashtagTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
(22, 6, 'right', 'component', 'User Suggest', NULL, 1, 'UserSuggest', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserSuggestWidget' ,NOW(), NOW(), 'shaun_core'),
...
(25, 10, 'right', 'component', 'User Trending', NULL, 1, 'UserTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
(26, 10, 'right', 'component', 'Hashtag Trending', NULL, 1, 'HashtagTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 2,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\HashtagTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
...
(29, 11, 'right', 'component', 'User Trending', NULL, 1, 'UserTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
...
(32, 5, 'right', 'component', 'User Trending', NULL, 1, 'UserTrending', 'desktop', '["all"]' ,'{"item_number":"10"}', 1,'Packages\\ShaunSocial\\Core\\Repositories\\Helpers\\Widget\\UserTrendingWidget' ,NOW(), NOW(), 'shaun_core'),
