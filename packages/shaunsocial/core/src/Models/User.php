...
class User extends UserCore
{
    ...
    public function getPermissionValue($permission)
    {
        ...
        return isset($permissions[$permission]) ? $permissions[$permission] : null;
    }
    ...
    public function getNotifySetting()
    {
        ...
        return array_merge($this->postNotifyDefault, $this->systemNotifyDefault, $this->followNotifyDefault, $this->chatNotifyDefault, $this->storyNotifyDefault, $result);
    }
