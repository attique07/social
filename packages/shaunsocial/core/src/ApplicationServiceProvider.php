    ...
    public function boot()
    {
        ...
        $this->app->afterResolving(Schedule::class, function (Schedule $schedule) {
            ...
            $schedule->command('model:prune',[
                '--model' => [HashtagTrending::class, PostHome::class, PostItem::class, StorageFile::class, UserHashtagSuggest::class, PersonalAccessToken::class, Distinct::class, UserHashtag::class, PostQueue::class, UserNotification::class, AdvertisingDelivery::class, AdvertisingStatistic::class],
            ])->everyTenMinutes();
        ...
        if (setting('broadcast.enable') && setting('broadcast.key') && ! env('CLOUD_ENABLE')) {
            config([
                ...
                'broadcasting.connections.pusher.options.host' => setting('broadcast.host'),
