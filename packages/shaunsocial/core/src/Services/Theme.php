...
class Theme
{
    ...
    {
        return '.feed-item, .comment_form, .p-dialog.post-detail-modal .p-dialog-content, .p-dialog.post-detail-modal .p-dialog-content .comment_form, .post-header-back{
            background-color: '.$value.';
        }';
    }
    ...
    // Feed Icon Color
    public function get_admin_title_item_feed_icon_color()
    {
        return __('Feed Icon Color');
    }
    public function get_css_feed_icon_color($value)
    {
    ...
    // Feed Icon Active Color
    public function get_admin_title_item_feed_icon_active_color()
    {
        return __('Feed Icon Active Color');
    }
    public function get_css_feed_icon_active_color($value)
    {
        return '.feed-main-action .feed-main-action-active{
            color: '.$value.';
        }';
    }

    // Feed Icon Bookmark Active Color
    public function get_admin_title_item_feed_icon_bookmark_active_color()
    {
        return __('Feed Icon Bookmark Active Color');
    }
    public function get_css_feed_icon_bookmark_active_color($value)
    {
        return '.feed-main-action .feed-main-action-bookmark-active{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.feed-item-like-text{
            color: '.$value.';
        }';
    }

     // Feed View More Text Color
     public function get_admin_title_item_feed_viewmore_text_color()
     {
         return __('Feed View More Text Color');
     }
     public function get_css_feed_viewmore_text_color($value)
     {
         return '.feed-comment-info-comment-holder-view-all{
             color: '.$value.';
         }';
     }
    ...
    {
        return '.feed-comment-info-comment-holder-border{
            border-color: '.$value.';
        }';
    }
    ...
    {
        return '.comment-item-icon-active{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu-name, .sidebar-user-menu-icon{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap{
            background-color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap, .sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap a{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap .sidebar-main-menu-item-icon{
            background-color: '.$value.';
        }
        .sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap .sidebar-main-menu-item-icon-more{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap:hover{
            background-color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap:hover, .sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap:hover a, .sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap:hover .sidebar-main-menu-item-icon-more{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap.router-link-exact-active, .sidebar-user-menu ul.sidebar-user-menu-list li .sidebar-user-menu-list-item-wrap.router-link-exact-active a {
            color: '.$value.';
        }';
    }
    ...
    {
        return '.main-content-menu-item.router-link-exact-active, .main-content-menu-item.active{
            color: '.$value.';
        }';
    }
    ...
    // Profile Header Menu Background Color
    public function get_admin_title_item_profile_menu_background_color()
    {
        return __('Profile Header Menu Background Color');
    }
    public function get_css_profile_menu_background_color($value)
    {
        return '.profile-menu-list-item{
            background-color: '.$value.';
        }';
    }

    // Profile Header Menu Text Color
    public function get_admin_title_item_profile_menu_text_color()
    {
        return __('Profile Header Menu Text Color');
    }
    public function get_css_profile_menu_text_color($value)
    {
        return '.profile-menu-list-item{
            color: '.$value.';
        }';
    ...
    // Profile Header Menu Background Active Color
    public function get_admin_title_item_profile_menu_background_active_color()
    {
        return __('Profile Header Menu Background Active Color');
    }
    public function get_css_profile_menu_background_active_color($value)
    {
        return '.profile-menu-list-item.active, .profile-menu-list-item.router-link-exact-active{
            background-color: '.$value.';
        }';
    }

    // Profile Header Menu Text Active Color
    public function get_admin_title_item_profile_menu_text_active_color()
    {
        return __('Profile Header Menu Text Active Color');
    }
    public function get_css_profile_menu_text_active_color($value)
    {
        return '.profile-menu-list-item.active, .profile-menu-list-item.router-link-exact-active{
            color: '.$value.';
        }';
    ...
    {
        return __('Post Status Modal');
    }
    public function get_admin_guide_image_group_status()
    {
        return $this->getThemeSettingGuideImage('post-status-modal');
    }
    
    // Post Status Modal Background Color
    public function get_admin_title_item_status_post_modal_background_color()
    {
        return __('Post Status Modal Background Color');
    }
    ...
    // Post Status Modal Close Icon Color
    public function get_admin_title_item_status_post_modal_close_icon_color()
    {
        return __('Post Status Modal Close Icon Color');
    }
    ...
    // Post Status Modal User Text Color
    public function get_admin_title_item_status_post_modal_user_text_color()
    {
        return __('Post Status Modal User Text Color');
    }
    public function get_css_status_post_modal_user_text_color($value)
    {
        return '.post-status-modal.p-dialog .p-dialog-content .status-box-main .status-box-header .status-box-user{
            color: '.$value.';
        }';
    }

    // Post Status Modal Textarea Color
    public function get_admin_title_item_status_post_modal_textarea_color()
    {
        return __('Post Status Modal Textarea Color');
    }
    ...
    // Post Status Modal Textarea Placeholder Color
    public function get_admin_title_item_status_post_modal_textarea_placeholder_color()
    {
        return __('Post Status Modal Textarea Placeholder Color');
    }
    ...
    // Post Status Modal Add Icon Background Color
    public function get_admin_title_item_status_post_modal_background_add_icon_color()
    {
        return __('Post Status Modal Add Icon Background Color');
    }
    ...
    // Post Status Modal Add Icon Border Color
    public function get_admin_title_item_status_post_modal_border_add_icon_color()
    {
        return __('Post Status Modal Add Icon Border Color');
    }
    ...
    // Post Status Modal Add Icon Color
    public function get_admin_title_item_status_post_modal_add_icon_color()
    {
        return __('Post Status Modal Add Icon Color');
    }
    ...
    // Post Status Modal Footer Border Color
    public function get_admin_title_item_status_post_modal_action_border_color()
    {
        return __('Post Status Modal Footer Border Color');
    }
    ...
    // Post Status Modal Footer Background Color
    public function get_admin_title_item_status_post_modal_action_background_color()
    {
        return __('Post Status Modal Footer Background Color');
    }
    ...
    // Post Status Modal Footer Icon Color
    public function get_admin_title_item_status_post_modal_action_icon_color()
    {
        return __('Post Status Modal Footer Icon Color');
    }
    public function get_css_status_post_modal_action_icon_color($value)
    {
        return '.post-status-modal.p-dialog .p-dialog-content .status-box-action .status-box-action-list-item{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.p-dialog .p-dialog-footer{
            background-color: '.$value.';
        }';
    }
    ...
    {
        return '.p-inputtext, .bg-input-background-color{
            background-color: '.$value.';
        }';
    }
    ...
    {
        return '.p-inputtext, .border-input-border-color{
            border-color: '.$value.';
        }';
    }
    ...
    {
        return '.p-inputtext, .text-input-text-color{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.p-inputtext-icon, .p-dropdown .p-dropdown-trigger, .p-treeselect .p-treeselect-trigger, .text-input-icon-color{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.p-inputtext::placeholder{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.p-dropdown, .p-dropdown-panel, .p-dropdown .p-inputtext{
            background-color: '.$value.';
        }';
    }
    ...
    {
        return '.p-dropdown .p-inputtext, .p-dropdown-panel .p-dropdown-items .p-dropdown-item{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.p-dropdown-panel .p-dropdown-items .p-dropdown-item:not(.p-highlight):not(.p-disabled):hover, .p-dropdown-panel .p-dropdown-items .p-dropdown-item.p-focus{
            color: '.$value.';
        }';
    }
    ...
    {
        return '.header-icons-list, .header-icons-list a{
            color: '.$value.';
        }';
    }
