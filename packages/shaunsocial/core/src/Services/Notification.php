...
class Notification
{
    ...
    public function send($users, $from, $notifyClass, $subject = null, $data = [], $package = 'shaun_core', $hasGroup = true, $unique = true)
    {
        ...
        foreach ($users as $user) {             
            ...
            if ($subject) {
                if (method_exists($subject, 'checkNotificationStop') && $subject->checkNotificationStop($user->id)) {
                    continue;
                }

                if (method_exists($subject, 'supportNotificationStop') && $subject->getNotificationStop($user->id)) {
                    continue;
                }
