    ...
    {    
        ...
        $result = [
            'config' => [
                ...
                'userVerifyExtensionSupport' => setting('user_verify.support_files'),
                'chatExtensionSupport' => setting('chat.support_files'),
                ...
                'postUploadExtensionSupport' => setting('post.support_files'),
