...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shaun_core::admin.dashboard.index', compact('title', 'userCount', 'userActiveCount', 'userInActiveCount', 'fileCount', 'postCount', 'hashtagCount', 'reportCount', 'userOnlineCount', 'pageOnlineCount', 'pageCount', 'pageActiveCount', 'pageInActiveCount'));
    }
