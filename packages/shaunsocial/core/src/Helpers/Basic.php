        ...
        foreach ($services as $service) {
            ...
            switch ($service->key) {
                ...
                case 'wasabi':
                    ...
                    $file['disks']['wasabi']['url'] = $config['url'];
...
if (!function_exists('setAppCookie')) {
    function setAppCookie($name, $value, $time)
    {
        $parse = parse_url(config('app.url'));
        if (empty($parse['path'])) {
            $parse['path'] = null;
        }
        cookie()->queue(cookie($name, $value, $time, $parse['path']));
    }
}
...
if (! function_exists('getFFMpeg')) {
    ...
    {        
        ...
        try {
            ...
            if (env('CLOUD_ENABLE') || env('SERVER_MIN')) {
    ...
    function getThemeSettingDefault()
    {
        return [
            ...
            'main_content' => [
                ...
                'main_content_menu_background_color' => '#fff',
            ...
            'profile' => [
                ...
                'profile_menu_background_color' => '#fff',
                'profile_menu_text_color' => '#333',
                'profile_menu_background_active_color' => '#66c7f4',
                'profile_menu_text_active_color' => '#fff',
            ],
            'global_search' => [                      
            ...
            'status' => [
                ...
                'status_post_modal_action_icon_color' => '#333333',
            ],
            'more' => [
            ...
            'sidebar' => [
                ...
                'sidebar_menu_item_background_active_color' => '#F4FCFF',
            ...
            'feed' => [
                ...
                'feed_dropdown_icon_color' => '#333',
                'feed_content_text_color' => '#333',
                'feed_icon_color' => '#333',
                'feed_content_share_background_color' => '#f2f2f2',
                'feed_icon_active_color' => '#eb3349',
                'feed_icon_bookmark_active_color' => '#66C7F4',
                'feed_like_text_color' => '#333',
                'feed_viewmore_text_color' => '#828282',
            ...
            'form' => [
                ...
                'input_placeholder_color' => '#BDBDBD',
            ...
            'chat' => [
                ...
                'room_item_background_active' => '#f4fcff',
                ...
                'message_form_background_color' => 'transparent',
    ...
    function getThemeSettingDarkDefault()
    {
        return [
            ...
            'main_content' => [
                ...
                'main_content_menu_background_color' => '#1e293b',
            ...
            'profile' => [
                ...
                'profile_menu_background_color' => '#1e293b',
                'profile_menu_text_color' => '#fff',
                'profile_menu_background_active_color' => '#2d88ff',
                'profile_menu_text_active_color' => '#fff',
            ],
            'global_search' => [                      
            ...
            'feed' => [
                ...
                'feed_icon_active_color' => '#eb3349',
                'feed_icon_bookmark_active_color' => '#2d88ff',
                'feed_like_text_color' => '#fff',
                'feed_viewmore_text_color' => '#94a3b8',
                'feed_slider_dot_background_color' => '#d9d9d9',
