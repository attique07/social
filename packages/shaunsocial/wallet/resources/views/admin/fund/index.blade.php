...
<div class="admin-card has-table">
    ...
    <p class="admin-card-help">
        {{ __("If you receive cash or transfer money outside the system, you can deposit money into member's wallets here.") }}
    </p>
    <div class="admin-card-body">
        ...
        <form id="send_fund_form" method="post" action="{{ route('admin.wallet.fund.send_fund')}}">
            ...
            <div class="form-group">
                <label class="control-label">{{__('Select Members')}}</label>
                <div class="control">
