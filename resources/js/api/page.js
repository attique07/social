...
export function storeDescriptionPage(description){
    return window.axios.post(`user_page/store_description`, {description: description}).then((response) => {
        return response.data.data
    })
}
...
export function storeCategoriesPage(categories){
    return window.axios.post(`user_page/store_category`, {categories: categories}).then((response) => {
        return response.data.data
    }) 
}
export function storeHashtagsPage(hashtags){
    return window.axios.post(`user_page/store_hashtag`, {hashtags: hashtags}).then((response) => {
        return response.data.data
    }) 
}
...
export function getSuggestUsersForAdmin(keyword){
