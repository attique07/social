<template>
    <div class="main-content-section bg-white border border-white text-main-color rounded-none md:rounded-base-lg p-5 mb-base-2 dark:bg-slate-800 dark:border-slate-800 dark:text-white mb-base-2">
    ...
    <div class="main-content-section bg-white border border-white text-main-color rounded-none md:rounded-base-lg p-5 mb-base-2 dark:bg-slate-800 dark:border-slate-800 dark:text-white mb-base-2">
        ...
        <div v-for="admin in adminsList" :key="admin.id" class="users-list-item flex items-center gap-base-2 mb-base-2">
            <Avatar :user="admin"/>
            <div class="flex-1 min-w-0">
