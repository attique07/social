<template>
	<CurrentPlan v-if="subscriptionDetail" :subscription="subscriptionDetail" @update="handleUpdateSubscription" class="mb-base-2"/>
...
<script>
import { getSubscriptionDetail, getTransactions } from '@/api/subscription'
