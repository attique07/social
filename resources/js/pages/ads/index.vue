                            ...
                            <tr v-for="advertisementItem in advertisementsList" :key="advertisementItem.id" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b border-table-border-color dark:border-gray-700">
                                ...
                                <td class="p-3">
                                    <div class="flex gap-4 justify-between items-center text-start">
                                        ...
                                        <router-link :to="{name: 'advertising_create', params: {id: advertisementItem.id}}" v-if="advertisementItem.canEdit" class="border border-secondary-box-color text-main-color rounded-md p-2 dark:border-white/30 dark:text-white"><BaseIcon name="pencil" size="16" /></router-link>
                                    </div>
                                </td>
...
export default {
    components: { Loading, BaseSelectStatus, BaseIcon, BaseButton, BaseSelect },
    data(){
        return {
            selectedStatus: 'all',
            statusList: [
