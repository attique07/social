...
router.beforeEach(async (to) => {
  ...
  document.querySelectorAll("#sidebarUserMenu").forEach(el => el.classList.remove('show'));
  document.querySelectorAll("#backdropModal").forEach(el => el.classList.remove('show'));
  document.querySelectorAll("#globalSearchMobile").forEach(el => el.classList.remove('show'));
})
