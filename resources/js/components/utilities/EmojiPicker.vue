<template>
	<DropdownMenu v-if="!isMobile" :appendTo="appendTo" :close-when-select="false">
		<template v-slot:dropdown-button>
			<BaseIcon name="emoji" class="emoji-picker" />
		</template>
		<div class="emoji-picker-box flex flex-col w-80 h-72">
			<div class="emoji-lists rounded-lg overflow-auto p-4 z-50">
