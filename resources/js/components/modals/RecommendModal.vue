<template>
    <div>
        <div class="flex gap-base-2 border-b border-divider pb-base-2 mb-base-2 dark:border-white/10">
            ...
            <div class="flex-1">
                <Mentionable v-model="content" :placeholder="isRecommend ? ($t('What do you recommend about') + ' ' + page.name + '?') : ($t('Leave your feedback for ') + page.name)" :rows="1" ref="recommendContent" :hasEventEnter="false" :autofocus="true" className="max-h-[75vh] lg:max-h-[60vh]"/>
            </div>
